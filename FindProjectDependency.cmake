# This function looks for a package in DEPENDENCY_${PACKAGE_NAME}_DIR first and then
...
# ${PROJECT_NAME}_DEPENDENCIES_INCLUDE_DIRS, ${PROJECT_NAME}_DEPENDENCIES_LIBRARY_DIRS and
# ${PROJECT_NAME}_DEPENDENCIES_LIBRARIES
MACRO(FIND_PROJECT_DEPENDENCY PACKAGE_NAME)

# We want the user to use DEPENDENCY_${PACKAGE_NAME}_DIR, and not ${PACKAGE_NAME}_DIR,
...
set(CMAKE_MODULE_PATH ${CUPID_DIR}/modules)
set(DEPENDENCY_${PACKAGE_NAME}_DIR "" CACHE PATH "${PACKAGE_NAME} installation base directory")
set(CMAKE_PREFIX_PATH ${DEPENDENCY_${PACKAGE_NAME}_DIR})
...
elseif("${PACKAGE_NAME}" STREQUAL "VTK")
    set(VTK_DIR ${DEPENDENCY_VTK_DIR})
...
if(NOT ${PACKAGE_NAME}_FOUND)
    message(FATAL_ERROR "${PACKAGE_NAME} not found. Try setting DEPENDENCY_${PACKAGE_NAME}_DIR to the installation path of ${PACKAGE_NAME}")
endif()
...
if(DEFINED ${PACKAGE_NAME}_DEPENDENCIES_INCLUDE_DIRS)
    set(${PROJECT_NAME}_DEPENDENCIES_INCLUDE_DIRS ${${PROJECT_NAME}_DEPENDENCIES_INCLUDE_DIRS}
        ${${PACKAGE_NAME}_DEPENDENCIES_INCLUDE_DIRS}
        CACHE INTERNAL "")
endif()
if(DEFINED ${PACKAGE_NAME}_DEPENDENCIES_LIBRARY_DIRS)
    set(${PROJECT_NAME}_DEPENDENCIES_LIBRARY_DIRS ${${PROJECT_NAME}_DEPENDENCIES_LIBRARY_DIRS}
        ${${PACKAGE_NAME}_DEPENDENCIES_LIBRARY_DIRS}
        CACHE INTERNAL "")
endif()
if(DEFINED ${PACKAGE_NAME}_DEPENDENCIES_PROVIDING_USE_FILES)
    set(${PROJECT_NAME}_DEPENDENCIES_PROVIDING_USE_FILES
        ${${PROJECT_NAME}_DEPENDENCIES_PROVIDING_USE_FILES}
        ${${PACKAGE_NAME}_DEPENDENCIES_PROVIDING_USE_FILES}
        CACHE INTERNAL "")
endif()
